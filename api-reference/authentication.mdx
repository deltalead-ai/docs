---
title: "REST API Authentication: API Keys and Headers"
...
<Steps>
  ...
  <Step title="Generate a New Key">
    Click **Generate New Key**, optionally give the key a descriptive label (for example, `Production – Zapier` or `Staging – internal`), and confirm. The full key value is displayed **only once** — copy it immediately and store it securely.
  </Step>
</Steps>
