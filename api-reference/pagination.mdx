...
description: "Los endpoints de listado de DeltaLead paginan por cursor: los parámetros cursor y limit permiten recorrer los leads página por página."
---
...
<ParamField query="cursor" type="string">
  Cadena de cursor opaca devuelta en el campo `next_cursor` de la respuesta anterior. Se omite este parámetro para empezar desde el inicio del conjunto de resultados.
</ParamField>

## Formato de la respuesta paginada

Todos los endpoints de listado devuelven los resultados en un arreglo `data`, con los dos campos de paginación al nivel raíz:
...
La respuesta no incluye un total de resultados. Contarlo exigiría una segunda consulta sobre el mismo filtro en cada página, y ningún listado de la plataforma lo hace. Para saber si quedan registros, alcanza con `has_more`.
