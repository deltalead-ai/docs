---
title: "Paginating DeltaLead API List Responses"
sidebarTitle: "Pagination"
description: "DeltaLead list endpoints use cursor-based pagination. Pass next_cursor from the response to retrieve the next page of results."
---
