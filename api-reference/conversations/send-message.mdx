---
title: "POST /v1/conversations/{id}/messages — Send a Message"
sidebarTitle: "Send Message"
description: "POST /v1/conversations/{id}/messages — send a message into an active conversation as a human agent, bypassing the AI."
---
