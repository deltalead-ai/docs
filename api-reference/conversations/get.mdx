---
title: "GET /v1/conversations/{id} — Retrieve a Conversation"
sidebarTitle: "Get Conversation"
description: "GET /v1/conversations/{id} — fetch a conversation including its full message history and AI-generated summary."
---
