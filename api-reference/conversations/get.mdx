...
<ParamField path="id" type="string" required>
  The unique identifier of the conversation to retrieve, e.g. `conv_xyz789`. You can obtain conversation IDs from the [List Conversations](/api-reference/conversations/list) endpoint or from webhook payloads.
</ParamField>
