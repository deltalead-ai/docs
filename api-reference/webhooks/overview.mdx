...
<Steps>
  <Step title="Abrir la configuración de webhooks">
    En el panel de DeltaLead, ir a **Organización → Integraciones → Custom Webhooks**. Como alternativa, se puede llamar directamente a `POST /v1/webhooks` desde la API.
  </Step>
