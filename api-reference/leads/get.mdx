---
title: "GET /v1/leads/{id} — Retrieve a Lead"
sidebarTitle: "Get Lead"
description: "GET /v1/leads/{id} — fetch the full profile and scoring details for a single lead by its unique identifier."
---
