...
DeltaLead posts an HTTP `POST` request to your endpoint whenever a lead event occurs. You configure which events trigger a webhook, and DeltaLead delivers the payload in real time — typically within a few seconds of the event.
