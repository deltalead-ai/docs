...
<Steps>
  <Step title="Open Settings">
    Log in to your DeltaLead account and open **Organization → Integrations** in the left sidebar.
  </Step>
